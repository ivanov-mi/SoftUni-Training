...
class PointInCircle
{
    static void Main()
    {
        // 6. Write an expression that ckecks if given point (x,y) is within a circle with radius 4 and centre of (0,0).
        ...
        {
            Console.WriteLine("Point with coordinate ({0},{1}) is withint a circle with radius 4 and centre of (0,0)", coordinateX, coordinateY);
        }
        else
        {
