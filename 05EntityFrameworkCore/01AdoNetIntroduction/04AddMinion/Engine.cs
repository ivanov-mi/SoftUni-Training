namespace AddMinion
{
    ...
    public class Engine
    {
        ...
        {
            var command = new SqlCommand(Queries.MinionId, connection);
        ...
        {
            var command = new SqlCommand(Queries.VillainId, connection);
        ...
        {
            var command = new SqlCommand(Queries.TownId, connection);
        ...
        {
            var command = new SqlCommand(Queries.InsertMinionsVillains, connection);
        ...
        {
            var command = new SqlCommand(Queries.InsertMinion, connection);
